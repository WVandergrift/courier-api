...
async def ember_home_landing() -> HTMLResponse:
    return HTMLResponse(
        (
            ...
            ".house-lights{position:fixed;z-index:1;right:clamp(24px,6vw,120px);bottom:clamp(72px,11vh,132px);width:min(52vw,720px);height:min(30vw,390px);"
            ...
            ".roof-a{left:7%;top:68%;width:39%;transform:rotate(-38deg)}.roof-b{left:37.5%;top:24.4%;width:60%;transform:rotate(23deg);animation-delay:-1.2s}"
            ".eave{left:7%;top:68%;width:86%;animation-delay:-2.5s}.gable-a{left:58.3%;top:68%;width:18.2%;transform:rotate(-40deg);animation-delay:-3.7s}"
            ".gable-b{left:72.2%;top:46.1%;width:19.3%;transform:rotate(38deg);animation-delay:-4.5s}"
            ...
            "@media(max-width:760px){.house-lights{right:-128px;bottom:52px;width:440px;height:240px;opacity:.3}footer{margin-top:54px}}"
            ...
            "<i class=\"strip gable-a\"></i><i class=\"strip gable-b\"></i></div>"
